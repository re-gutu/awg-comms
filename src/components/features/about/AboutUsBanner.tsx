    ...
    >
      ...
      <div className="container mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          >
            Where{" "}
            <span className="text-primary font-serif italic">Cinematic</span>{" "}
            Storytelling Meets <br />
            Data-Driven Growth.
          </motion.h1>
          ...
          >
            ...
            <span className="text-white font-medium">digital engines</span> that
            drive measurable success for brands across Ethiopia and beyond.
          </motion.p>
        ...
        <motion.div
          ...
          className="relative order-1 lg:order-2 h-[45vh] lg:h-[65vh] w-full"
        >
          <motion.div
